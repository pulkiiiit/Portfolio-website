      ...
      <main className="max-w-4xl mx-auto px-4 pb-24" style={{ opacity: 1 }}>
        ...
        <section id="projects" className="py-8 px-4 md:px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8">
                ...
                <div className="md:col-span-7 space-y-3 md:space-y-4">
                  ...
                  <div className="flex items-center gap-3 md:gap-4 pt-2">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-external-link">
          ...
          <div className="flex justify-center mt-12">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-chevron-down"><path d="m6 9 6 6 6-6"></path></svg></button>
          </div>
        </section>
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-2 lg:gap-4">
                  ...
                  <div className="flex items-center gap-2 text-gray-400 text-sm md:text-base shrink-0"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-calendar text-gray-500">
